...
class FetchNowPlayingUseCase extends UseCase<List<MovieEntity>, void> {
  final HomeMoviesRepo homeMoviesRepo;
  FetchNowPlayingUseCase(this.homeMoviesRepo);

  @override
  Future<Either<Failure, List<MovieEntity>>> execute([void param]) async {
    return await homeMoviesRepo.fetchNowPlaying();
  }
}
